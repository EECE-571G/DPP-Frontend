...
// Addresses from your deployment logs (e.g., on Sepolia, Base Sepolia, etc.):
// Find these in your `broadcast/` folder or deployment script output
...
const token1Raw = "0xa513E6E4b8f2a923D98304ec87F64353C4D5C853";                  // <<< REPLACE (e.g., USDC on Sepolia)
...
export const TARGET_NETWORK_CHAIN_ID = 31337n // Example: Sepolia Chain ID (use BigInt 'n')
export const TARGET_NETWORK_NAME = "Anvil Localhost";
export const EXPLORER_URL_BASE = null; // Example: Sepolia Etherscan base URL for TX links
